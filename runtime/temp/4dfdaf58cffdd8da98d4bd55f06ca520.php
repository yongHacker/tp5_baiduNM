<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:80:"E:\PHP\wamp\www\tp5_baiduNM\public/../application/admin\view\category\index.html";i:1519389690;s:79:"E:\PHP\wamp\www\tp5_baiduNM\public/../application/admin\view\public\header.html";i:1519384354;s:79:"E:\PHP\wamp\www\tp5_baiduNM\public/../application/admin\view\public\footer.html";i:1489469585;}*/ ?>
<!--包含头部文件-->
<!DOCTYPE HTML>
<html>
<head>
			...
			<tbody>
				...
				<tr class="text-c">
					...
					<td class="td-manage">
						...
						<a style="text-decoration:none" class="ml-5" onClick="o2o_s_edit('编辑','<?php echo url('category/edit',['id'=>$vo['id']]); ?>','',300)"><i class="Hui-iconfont">&#xe6df;</i></a>
						<a style="text-decoration:none" class="ml-5" onClick="o2o_del('<?php echo url('category/status',['id'=>$vo['id'],'status'=>-1]); ?>')" href="javascript:;" title="删除"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
				</tr>
