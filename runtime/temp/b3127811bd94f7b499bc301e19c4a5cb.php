<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:77:"E:\PHP\wamp\www\tp5_baiduNM\public/../application/index\view\index\index.html";i:1519388878;s:77:"E:\PHP\wamp\www\tp5_baiduNM\public/../application/index\view\public\head.html";i:1518848629;s:76:"E:\PHP\wamp\www\tp5_baiduNM\public/../application/index\view\public\nav.html";i:1489469585;}*/ ?>
  ...
  <div class="nav-inner">
    ...
    <div class="container">
        <div class="top-container">
            <div class="mid-area">
                <div class="slide-holder" id="slide-holder">
                    ...
                    <ul class="slideshow">
                        <li><a href="" class="item-large"><img class="ad-pic" src="__STATIC__/index/image/TB1JNc6o4PI8KJjSspfSuwCFXXa.jpg" /></a></li>
                        <li><a href="" class="item-large"><img class="ad-pic" src="__STATIC__/index/image/TB12C6fgZnI8KJjSsziSuv8QpXa.jpg" /></a></li>
                    </ul>
                </div>
        ...
        <div class="right-sidebar">
            <div class="right-ad">
                <ul class="slidepic">
                    <li><a><img src="__STATIC__/index/image/TB1WgtnXdHO8KJjSZFtSuwhfXXa.jpg" width="259px" /></a></li>
                </ul>
            </div>
                                ...
                                <li class="j-card">
                                    ...
                                    <div class="contentbox">
                                        <a href="<?php echo url('detail/index', ['id'=>$vo['id']]); ?>" target="_blank">
                                            <div class="header">
                                                <h4 class="title ">【<?php echo countLocation($vo['location_idx']); ?>店通用】</h4>
                                            </div>
    ...
    <div class="footer-content">
        <div class="copyright-info">
            <p style="text-align: center;margin: 50px auto">网站制作者：deng <br> 联系方式：754354600@qq.com</p>
        </div>
    </div>
    ...
    <script>
        ...
        //轮播图自动轮播
        var time = setInterval(moveleft,50000000);
