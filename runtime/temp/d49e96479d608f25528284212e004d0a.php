<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:80:"E:\PHP\wamp\www\tp5_baiduNM\public/../application/admin\view\featured\index.html";i:1518536564;s:79:"E:\PHP\wamp\www\tp5_baiduNM\public/../application/admin\view\public\header.html";i:1519384354;s:79:"E:\PHP\wamp\www\tp5_baiduNM\public/../application/admin\view\public\footer.html";i:1489469585;}*/ ?>
<!--包含头部文件-->
<!DOCTYPE HTML>
<html>
<head>
    ...
    <table class="table table-border table-bordered table-bg table-hover table-sort">
      ...
      <tbody>
        ...
        <tr class="text-c">
          ...
          <td class="td-status">
            <a href="<?php echo url('featured/status',['id'=>$vo['id'], 'status'=>$vo['status']==1?0:1]); ?>" title="点击修改状态"><?php echo status($vo['status']); ?></a>
          </td>
          <td class="td-manage">
            <a style="text-decoration:none" class="ml-5" onClick="o2o_del('<?php echo url('featured/status', ['id'=>$vo['id'], 'status'=>-1]); ?>')" href="javascript:;" title="删除">
